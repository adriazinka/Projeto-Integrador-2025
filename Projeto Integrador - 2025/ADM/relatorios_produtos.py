...
def criar_janela():
    ...
    # URL da API Flask
    API_URL = f"{conf.url_api}/produtos" 

    # Criar janela principal
    root = tk.Tk()
    root.title("Relatório de Produtos")
    ...
    tree = ttk.Treeview(frame, columns=("ID", "Produto", "Quantidade", "Validade", "Sabores"), show="headings",)
    ...
    tree.heading("Sabores", text="Sabores")

    # Ajustar tamanho das colunas
    tree.column("ID", width=50, anchor="center")
    tree.column("Produto", width=200)
    tree.column("Quantidade", width=150)
    tree.column("Validade", width=250)
    tree.column("Sabores", width=250)
